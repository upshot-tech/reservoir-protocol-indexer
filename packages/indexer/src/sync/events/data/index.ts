...
export type EventSubKind =
  ...
  | "ditto-pool-created"
  | "ditto-change-base-price"
  | "ditto-change-delta"
  | "ditto-change-admin-fee-recipient"
  | "ditto-change-admin-fee"
  | "ditto-change-admin-lp-fee"
  | "ditto-trade-swapped-tokens-for-nft"
  | "ditto-trade-swapped-nft-for-tokens"
  | "ditto-liquidity-added"
  | "ditto-liquidity-removed"
  | "ditto-ditto-pool-created"
  | "caviar-v1-create"
  | "caviar-v1-add"
  | "caviar-v1-remove"
  | "caviar-v1-buy"
